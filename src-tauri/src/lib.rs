...
use lcdiff_core::{
    Archive, ArchiveDiff, CommitResult, DecompileEngine, EntryKind, Error as CoreError, compare,
...
use events::{DeepSearchMatch, SearchProgress, emit_search_progress, emit_search_result};
use menu::{
...
use state::{
    AppState, ArchiveSummary, SharedState, SideSnapshot, ViewSourceSnapshot, ViewSourceSummary,
    archive, side_snapshot,
};
...
fn resolve_view_nested_archive(
    source: &ViewSourceSnapshot,
    nested_path: &str,
