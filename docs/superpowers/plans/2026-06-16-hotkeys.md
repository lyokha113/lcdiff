...
**Goal:** Add LCDiff keyboard shortcuts through a frontend action registry shared by native Tauri menu accelerators and in-window keydown handling.
...
In `README.md`, under `## Using LCDiff`, after the numbered workflow list, add:

```md
### Keyboard shortcuts

LCDiff supports app-level keyboard shortcuts while the app window is focused.
