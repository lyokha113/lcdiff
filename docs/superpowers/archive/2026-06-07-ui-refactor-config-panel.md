...
**Goal:** Reorganize the jdiff frontend so File Tree + Diff fill the center with no page scroll, move all configuration into a right-side push drawer, collapse file pickers to a compact chip bar, and replace text controls with lucide icons.
